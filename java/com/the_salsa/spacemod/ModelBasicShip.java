...
public class ModelBasicShip extends ModelBase
{
  ...
  public ModelBasicShip()
  {
    ...
    textureHeight = 256;
      ...
      cockpitTop.addBox(-6F, -14F, -4F, 12, 0, 14);
      ...
      cockpitRight.addBox(6F, -14F, -4F, 0, 9, 14);
      ...
      cockpitLeft.addBox(-6F, -14F, -4F, 0, 9, 14);
      ...
      cockpitFront.addBox(-6F, -14F, 10F, 12, 9, 0);
      ...
      cockpitBack.addBox(-6F, -14F, -4F, 12, 9, 0);
      cockpitBack.setRotationPoint(0F, 12F, 0F);
      cockpitBack.setTextureSize(256, 256);
      cockpitBack.mirror = true;
      setRotation(cockpitBack, 0F, 3.141593F, 0F);
