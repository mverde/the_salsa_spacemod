...
public class SpaceSkyRenderer extends IRenderHandler
{
	...
	public void render(float partialTicks, WorldClient world, Minecraft mc)
	{
		...
		mc.renderEngine.bindTexture(new ResourceLocation(SpaceMod.MODID, "environment/earth.png"));
		...
		mc.renderEngine.bindTexture(new ResourceLocation(SpaceMod.MODID, "environment/sun_phases.png"));
